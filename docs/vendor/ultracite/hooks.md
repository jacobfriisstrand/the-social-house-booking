Source: https://www.ultracite.ai/docs/git-hooks
Fetched: 2026-08-24

# Git Hooks

_Run Ultracite automatically before each commit with Husky, Lefthook, lint-staged, or pre-commit so staged files stay clean and consistent._
