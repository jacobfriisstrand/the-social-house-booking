Source: https://www.ultracite.ai/docs/migrate/eslint
Fetched: 2026-08-24

# Migrate from ESLint

_Migrate an ESLint-based project to Ultracite while keeping plugin-driven workflows, formatter alignment, and project-specific overrides._
...
If you prefer more control over the process, follow the [Setup](https://www.ultracite.ai/docs/setup#installation) steps and manually remove ESLint and its configuration files.
