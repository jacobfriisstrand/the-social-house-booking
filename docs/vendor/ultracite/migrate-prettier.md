Source: https://www.ultracite.ai/docs/migrate/prettier
Fetched: 2026-08-24

# Migrate from Prettier

_Replace standalone Prettier setup with Ultracite while preserving formatting expectations and aligning the rest of your linting stack._
...
The fastest way is to run the [automatic setup script](https://www.ultracite.ai/docs/setup#installation).
...
If you switch to Biome or Oxlint (which have built-in formatters), Ultracite automatically removes the existing Prettier configuration. This will:
...
If you prefer more control over the process, follow the [Setup](https://www.ultracite.ai/docs/setup#installation) steps and manually remove Prettier and its configuration files.
