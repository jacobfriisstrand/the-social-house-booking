Source: https://www.ultracite.ai/docs/usage
Fetched: 2026-08-24

# Usage

_This section covers how to use Ultracite on a day-to-day basis — covering the command-line interface, editor integration details, and typical workflows._
...
- Agents run non-interactively with scoped permissions: Claude Code uses `--permission-mode acceptEdits` limited to read/edit tools (no shell access), and Codex runs in its workspace-write sandbox via `codex exec --full-auto`.
