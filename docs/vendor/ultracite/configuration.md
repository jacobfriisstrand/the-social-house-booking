Source: https://www.ultracite.ai/docs/configuration
Fetched: 2026-08-24

# Configuration

_Understand Ultracite's default presets, how framework-specific layers work, and which overrides to keep when your project needs custom rules._
