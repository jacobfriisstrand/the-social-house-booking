Source: https://www.ultracite.ai/docs/setup
Fetched: 2026-08-24

# Setup

_Install Ultracite with your preferred package manager, choose the right presets, and generate editor and agent config for your project._

Ultracite can be installed with all major package managers. You'll need Node.js 20+ and a project with a `package.json` file. If you're new to Ultracite, the [introduction](https://www.ultracite.ai/docs) covers what it is and which toolchains it supports.
...
| `--js-plugins` | Optional Oxlint JS plugins to enable. | Space-separated: `anti-slop`, `eslint-plugin-github`, `eslint-plugin-sonarjs`, `oxlint-plugin-react-doctor` |
